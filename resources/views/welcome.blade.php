...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Carnival Easy Panel</title>
        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 light:bg-gray-900 sm:items-center sm:pt-0">
            ...
            <div class=" mx-auto text-center">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                      <h1 >Carnival Easy Panel</h1>
                      <p class="card-text">Paschim Bazar, Bakshiganj, Jamalpur</p>
                      <p class="card-text"><small class="text-muted">Contact: 01770033448</small></p>
                    </div>
                  </div>
            </div>
        </div>
